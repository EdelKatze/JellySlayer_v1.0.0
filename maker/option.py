...
def mainloop(funclist:list):
    ...
    while run:
        ...
        list1.draw(window)
        pygame.display.flip()
        # print(list1.option_list[list1.selected])
        selection = list1.option_list[list1.selected]
        for event in pg.event.get():
            if event.type == pg.QUIT:
                # pg.quit()

                return func_dict[selection]
